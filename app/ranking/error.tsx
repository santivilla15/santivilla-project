// Error Boundary específico para la página de ranking
'use client'
...
const translations = {
  es: {
    ...
    message: 'No pudimos cargar el ranking. Esto puede deberse a un problema de conexión o con la base de datos.',
    tryAgain: 'Intentar de nuevo',
    goHome: 'Ir al inicio',
    tryAgainAria: 'Intentar cargar el ranking de nuevo',
    goHomeAria: 'Ir a la página principal',
    errorDetails: 'Detalles del error (solo en desarrollo)',
  },
  en: {
    title: 'Error loading ranking',
    message: 'We couldn\'t load the ranking. This may be due to a connection issue or database problem.',
    tryAgain: 'Try again',
    goHome: 'Go home',
    tryAgainAria: 'Try loading ranking again',
    goHomeAria: 'Go to home page',
    errorDetails: 'Error details (development only)',
  },
  de: {
    title: 'Fehler beim Laden des Rankings',
    message: 'Wir konnten das Ranking nicht laden. Dies kann auf ein Verbindungsproblem oder ein Datenbankproblem zurückzuführen sein.',
    tryAgain: 'Erneut versuchen',
    goHome: 'Zur Startseite',
    tryAgainAria: 'Ranking erneut laden',
...
export default function RankingError({
  ...
  useEffect(() => {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.error('Error en página de ranking:', error)
    }
  }, [error])
